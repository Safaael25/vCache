"""
Runs mixed_cost_recency_workload_v2.json across cache sizes = 10/20/30/40/50/60/70%
...
dataset_path = os.path.join(os.path.dirname(__file__), "mixed_cost_recency_workload_v2.json")
...
results_dir = os.path.join(os.path.dirname(__file__), "mixed_cost_recency_sweep_v2_results")
...
print("=== FULL RESULTS: mixed_cost_recency_workload_v2.json ===")
for max_size in CACHE_SIZES:
